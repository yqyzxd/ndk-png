...
png_bytep PngDecoder::decode() {
    ...
    LOGE("PngDecoder before png_set_read_fn");
    png_set_read_fn(png_ptr, this, png_read_callback);
    LOGE("PngDecoder after png_set_read_fn");
    ...
    LOGE("PngDecoder decode rowbytes:%d",rowbytes);
    ...
    LOGE("PngDecoder before png_read_image");
    png_read_image(png_ptr, &row_pointers[0]);

    LOGE("PngDecoder after png_read_image");
